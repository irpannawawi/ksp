...
<head>
    ...
    <link href="ksp/css/sb-admin-2.min.css" rel="stylesheet">
...
<body class="bg-gradient-primary">
                            ...
                            <div class="col-lg-6">
                                <div class="p-5">
                                    <div class="text-center">
                                        <h1 class="h4 text-gray-900 mb-4">KSP TUNAS MUDA</h1>
                                    </div>
    ...
    <script src="ksp/vendor/jquery/jquery.min.js"></script>
    <script src="ksp/vendor/bootstrap/js/bootstrap.bundle.min.js"></script>

    <!-- Core plugin JavaScript-->
    <script src="ksp/vendor/jquery-easing/jquery.easing.min.js"></script>
