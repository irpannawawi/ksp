...
<div class="container-fluid">
    ...
    <div class="card">
        <div class="card-header">
            <h3 class="float-left">Riwayat Pembayaran Angsuran</h3>
            <a href="{{url('bayar_angsuran/'.$pencairan->no_pencairan)}}" class="btn btn-primary btn-sm float-right">Bayar angsuran</a>
        </div>
        <div class="card-body">
            ...
            <table class="table table-hover table-stiped">
                <tr class="bg-dark text-white">
                    <th colspan="8">Riwayat Angsuran</th>
                </tr>
                <tr>
                    <th>No</th>
                ...
                <tr>
                    ...
                    <td>
                    <a class="btn btn-primary btn-sm" href="{{url('print_kwitansi')}}/angsuran/{{$data->no_angsuran}}"><i class="fa fa-print"></i></a>
                    </td>
                </tr>
                @endforeach
